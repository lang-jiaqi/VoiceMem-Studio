...
用法：python3 studio/tools/install_backchannel_clips.py studio/resources/voice/backchannel
...
from studio.core.utils.turn_taking.backchannel import BackchannelVoice

src = sys.argv[1] if len(sys.argv) > 1 else str(VOICE / "backchannel")
bc = BackchannelVoice(BreezeMLXTTS(ref_audio=str(VOICE / "noctelle_ref_short.wav")), lang="zh")
n = 0

"""Studio dialogue and TTS prompt configuration; restart after editing.

The configuration is bundled with the Studio package and never read in the
audio loop. An explicit directory replaces the complete configuration set.
"""
...
def prompt_directory():
    explicit = os.environ.get("STUDIO_PROMPT_DIR") or os.environ.get("VOICEMEM_PROMPT_DIR")
    if explicit:
